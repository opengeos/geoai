...
class TestDetectionTools:
    ...
    @pytest.mark.asyncio
    async def test_detect_features_missing_file(
        self, temp_input_dir, temp_output_dir
    ):
...
class TestChangeDetectionTools:
    ...
    @pytest.mark.asyncio
    async def test_detect_changes_missing_files(
        self, temp_input_dir, temp_output_dir
    ):
...
class TestDownloadTools:
    ...
    @pytest.mark.asyncio
    async def test_download_imagery_invalid_bbox(
...
class TestFoundationModelTools:
    ...
    @pytest.mark.asyncio
    async def test_extract_features_missing_file(
        self, temp_input_dir, temp_output_dir
    ):
...
class TestUtilityTools:
    ...
    @pytest.mark.asyncio
    async def test_list_files_invalid_directory(
        self, temp_input_dir, temp_output_dir
    ):
    ...
    @pytest.mark.asyncio
    async def test_clean_results_missing_file(
        self, temp_input_dir, temp_output_dir
    ):
