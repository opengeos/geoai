...
class TestOSDClassification(unittest.TestCase):
    def setUp(self):
        ...
        self.input_dir = Path(self.temp_dir.name) / "S2A_MSIL1C_20230515T012345_N0509_R068_T54NVD_20230515T012345.SAFE"
    ...
    def test_missing_dependency(self):
        ...
        sys_modules_patch = {
            k: None for k in list(sys.modules.keys()) if k == "opticallyshallowdeep" or k.startswith("opticallyshallowdeep.")
        }
    ...
    def test_classify_l2r_success(self):
        ...
        dummy_l2r = Path(self.temp_dir.name) / "S2A_MSI_2023_05_15_01_23_45_T54NVD_L2R.nc"
