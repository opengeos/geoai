...
class TestClayEmbeddingSaveLoad(unittest.TestCase):
    ...
    def test_save_load_embeddings_npz(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            embeddings = self.clay_model.generate(image, bounds, date, only_cls_token=True)
    ...
    def test_save_load_embeddings_pt(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            torch.testing.assert_close(loaded_data["embeddings"], torch.from_numpy(embeddings_np))
...
class TestClayLoadMetadata(unittest.TestCase):
    ...
    def test_load_metadata_no_parameters(self):
        ...
        with self.assertRaisesRegex(ValueError, "Must provide either sensor_name or custom_metadata"):
            load_metadata()
...
class TestClayValidateMetadata(unittest.TestCase):
    ...
    def test_validate_metadata_extra_band_stats(self):
        ...
        with self.assertRaisesRegex(ValueError, "bands.mean has 2 entries but expected 1"):
            validate_metadata(invalid_metadata)
    ...
    def test_validate_metadata_missing_bands_key(self):
        ...
        with self.assertRaisesRegex(ValueError, "Missing required bands key: wavelength"):
            validate_metadata(invalid_metadata)
