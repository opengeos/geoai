...
_LAZY_SYMBOL_MAP = {
    ...
    "create_raster_dataset": ("utils", None),
    "create_segmentation_dataset": ("utils", None),
    "create_geo_sampler": ("utils", None),
    "create_geo_dataloader": ("utils", None),
    "create_geo_dataloaders": ("utils", None),
    "create_torchgeo_segmentation_dataloaders": ("utils", None),
    "geo_sample_to_tuple": ("utils", None),
    "predict_torchgeo_segmentation_batch": ("utils", None),
    "plot_torchgeo_segmentation_predictions": ("utils", None),
    "train_torchgeo_segmentation_model": ("utils", None),
