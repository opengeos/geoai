...
for band in bands:
    ...
    print(f"{band}:")
    print(f"  mean: core={core_mean}, custom={custom_mean}, diff={abs(core_mean - custom_mean)}")
    print(f"  std: core={core_std}, custom={custom_std}, diff={abs(core_std - custom_std)}")
    print(f"  wavelength: core={core_wave}, custom={custom_wave}, diff={abs(core_wave - custom_wave)}")