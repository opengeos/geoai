...
def main():
    ...
    verification_scripts = [
        ('compare_embeddings.py', 'Basic numerical comparison with appropriate tolerances'),
        ('verify_functional_equivalence.py', 'Downstream task performance verification'),
    ...
    if all_passed:
        ...
        print("   • TestClay_GeoAI.py: Convenient wrapper for individual image processing")
