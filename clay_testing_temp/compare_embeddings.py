...
def compare_embeddings(embeddings1, embeddings2):
    ...
    if not np.allclose(embeddings1, embeddings2, atol=1e-3):
        ...
        print("⚠️ Embeddings have minor numerical differences (likely due to processing order)")
...
def main():
    ...
    if results['functionally_identical']:
        ...
        print("   Small numerical differences are due to processing order (batched vs individual)")
        ...
        print("   Differences are likely due to numerical precision - functionally equivalent")
